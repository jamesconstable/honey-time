...
(function($PS) {
  ...
  "use strict";
  $PS["Confetti"] = $PS["Confetti"] || {};
  var exports = $PS["Confetti"];
  var $foreign = $PS["Confetti"];
  var Data_Options = $PS["Data.Options"];               
  var spread = Data_Options.opt("spread");
  var scalar = Data_Options.opt("scalar");
  var particleCount = Data_Options.opt("particleCount");
  var confetti = function (opts) {
      return $foreign.confettiImpl(Data_Options.options(opts));
  };
...
(function($PS) {
  ...
  var elementsBySelector = function (selector) {
      return function __do() {
          ...
          var l = Data_Functor.map(Effect.functorEffect)((function () {
              var $111 = Data_Show.show(Data_Show.showInt);
              return function ($112) {
                  return $111(Data_Array.length($112));
              };
  ...
  var delay = function (millis) {
      return function (action) {
          return Data_Functor.map(Effect.functorEffect)(Data_Function["const"](Data_Unit.unit))(Effect_Timer.setTimeout(millis)(action));
      };
  };
  ...
  var newYearEffect = function __do() {
      var message = elementsBySelector(".textual-display .message")();
      Data_Foldable.foldMap(Data_Foldable.foldableArray)(Effect.monoidEffect(Data_Monoid.monoidUnit))((function () {
          var $113 = Web_DOM_Node.setTextContent("Happy Sajem Tan\x0aNew Year!");
          return function ($114) {
              return $113(Web_DOM_Element.toNode($114));
          };
      })())(message)();
      var body = elementsBySelector("body")();
      Data_Foldable.foldMap(Data_Foldable.foldableArray)(Effect.monoidEffect(Data_Monoid.monoidUnit))(function (e) {
          return Control_Apply.applySecond(Effect.applyEffect)(addClass("theme-new-year")(e))(delay(4000)(removeClass("theme-new-year")(e)));
      })(body)();
      return Confetti.confetti(Data_Semigroup.append(Data_Options.semigroupOptions)(Data_Options.assoc(Confetti.scalar)(2.0))(Data_Semigroup.append(Data_Options.semigroupOptions)(Data_Options.assoc(Confetti.spread)(180.0))(Data_Options.assoc(Confetti.particleCount)(150))))();
  };
  var attachPartyPopperHandler = function __do() {
      var listener = Web_Event_EventTarget.eventListener(function (v) {
          return newYearEffect;
      })();
      var buttons = Data_Functor.map(Effect.functorEffect)(Data_Functor.map(Data_Functor.functorArray)(Web_DOM_Element.toEventTarget))(elementsBySelector(".party-poppers button"))();
      return Data_Foldable.foldMap(Data_Foldable.foldableArray)(Effect.monoidEffect(Data_Monoid.monoidUnit))(Web_Event_EventTarget.addEventListener("click")(listener)(false))(buttons)();
  };
      ...
      return function (display) {
                          ...
                          if (v instanceof ThemeComponent) {
                              ...
                              return Data_Foldable.foldMap(Data_Foldable.foldableArray)(Effect.monoidEffect(Data_Monoid.monoidUnit))(function (e) {
                                  return function __do() {
                                      ...
                                      removeClass("theme-" + Data_Show.show(Data_Show.showInt)(lastMythRole))(e)();
                                      removeClass("theme-0-controls")(e)();
                                      removeClass("theme-" + (Data_Show.show(Data_Show.showInt)(lastMythRole) + "-controls"))(e)();
                                      addClass("theme-" + Data_Show.show(Data_Show.showInt)(v1 + 1 | 0))(e)();
                                      return addClass("theme-" + (Data_Show.show(Data_Show.showInt)(v1 + 1 | 0) + "-controls"))(e)();
                                  };
                              })(v.value0);
                          };
                          throw new Error("Failed pattern match at Main (line 304, column 5 - line 304, column 73): " + [ v.constructor.name, v1.constructor.name, v2.constructor.name ]);
                      };
                  };
              };
          };
          var setText = function (es) {
              return function (t) {
                  return Data_Foldable.foldMap(Data_Foldable.foldableArray)(Effect.monoidEffect(Data_Monoid.monoidUnit))((function () {
                      var $115 = Web_DOM_Node.setTextContent(t);
                      return function ($116) {
                          return $115(Web_DOM_Element.toNode($116));
                      };
                  })())(es);
              };
          };
          ...
          var setComponent = function (c) {
              return function (n) {
                  ...
                  throw new Error("Failed pattern match at Main (line 272, column 24 - line 280, column 45): " + [ c.constructor.name ]);
              };
          };
          ...
          return Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)(Control_Apply.applySecond(Effect.applyEffect)(set(function (v) {
              ...
              return v.subsecond;
          })))(setTheme()(display.theme)(date.mythRole)(date.subsecond));
      };
  };
  var displayNow = function (ds) {
      return function (firstNewYearRef) {
          return function __do() {
              ...
              var $109 = honeyDate.dayOfYear === 359;
              if ($109) {
                  ...
                  if (isFirstTime) {
                      newYearEffect();
                      return Effect_Ref.write(false)(firstNewYearRef)();
                  };
                  return Data_Monoid.mempty(Effect.monoidEffect(Data_Monoid.monoidUnit))();
              };
  ...
  var setup = Data_Functor["void"](Effect.functorEffect)(function __do() {
      var textual = getTextualDisplay();
      var graphical = getGraphicalDisplay();
      var newYearRef = Effect_Ref["new"](true)();
      attachPartyPopperHandler();
      return Effect_Timer.setInterval(Data_Int.floor(honeyDurations.subsecond))(displayNow([ textual, graphical ])(newYearRef))();
  });
  exports["None"] = None;
  ...
  exports["attachPartyPopperHandler"] = attachPartyPopperHandler;
  exports["setup"] = setup;
  exports["main"] = main;
})(PS);
PS["Main"].main();